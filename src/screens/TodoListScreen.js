  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.footer}>
        <TouchableOpacity onPress={() => dispatch(clearCompleted())} style={styles.footerButton}>
          <Text style={styles.footerButtonText}>Clear Completed</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
...
const styles = StyleSheet.create({
  ...
  header: { backgroundColor: '#3498db', padding: 20, paddingTop: 40 },
  title: { fontSize: 28, fontWeight: 'bold', color: 'white', textAlign: 'center' },
  stats: { fontSize: 14, color: 'rgba(255,255,255,0.9)', textAlign: 'center', marginTop: 8 },
  inputContainer: {
    flexDirection: 'row',
    padding: 16,
  ...
  addButton: { backgroundColor: '#3498db', borderRadius: 8, padding: 12, justifyContent: 'center', alignItems: 'center' },
  addButtonDisabled: { opacity: 0.5 },
  filterContainer: { flexDirection: 'row', padding: 16, backgroundColor: 'white', borderBottomWidth: 1, borderBottomColor: '#e0e0e0' },
  filterButton: {
    flex: 1,
    paddingVertical: 8,
  ...
  footer: { padding: 12, alignItems: 'center', backgroundColor: 'white' },
  footerButton: { padding: 10, backgroundColor: '#e0e0e0', borderRadius: 8 },
  footerButtonText: { color: '#333', fontWeight: '600' },
});
